...
internal class TreatmentConfiguration : IEntityTypeConfiguration<Treatment>
{
    public void Configure(EntityTypeBuilder<Treatment> builder)
    {
        ...
        builder.HasData(
            new { Id = Guid.Parse("68a14b26-15d6-4831-a876-221b01260c6b"), Name = "Acupuncture", Price = 550m, Duration = TimeSpan.FromMinutes(45), CertificationRequired = CertificationTypes.Acupuncture, MaxParticipants = 1 },
