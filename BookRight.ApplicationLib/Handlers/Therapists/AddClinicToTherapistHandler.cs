...
public class AddClinicToTherapistHandler(ITherapistRepository therapistRepository, IClinicRepository clinicRepository) : IAddClinicToTherapistHandler
{
    async Task IAddClinicToTherapistHandler.Handle(AddClinicToTherapistCommand command)
    {
        ...
        therapist.AddAssociatedClinic(command.ClinicId);
