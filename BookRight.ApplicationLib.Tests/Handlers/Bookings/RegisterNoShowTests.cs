...
public class RegisterNoShowTests
{
    ...
    // ---------------------------------------------------------
    // 1. Handle tests (Registering NoShow through Application)
    // ---------------------------------------------------------

    [Fact]
    public async Task Handle_GivenValidBookingId_SetsStatusToNoShow()
    {
        // Arrange
        ...
        var command = new RegisterNoShowCommand(booking.Id);
    ...
    public async Task Handle_GivenEmptyBookingId_CastApplicationException()
    {
        ...
        var command = new RegisterNoShowCommand(Guid.Empty);
    ...
    public async Task Handle_GivenUnknownBookingId_CastNotFoundException()
    {
        ...
        var command = new RegisterNoShowCommand(UnknownBookingId);
